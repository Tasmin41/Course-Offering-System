                ...
                <div class="body col-xl-9 p0">
					...
					<?php 
					  $db = new courseDatabase();
					   if(isset($_GET['delid'])){
						    $delid = $_GET['delid'];
							$delquery="delete from second_semester where id= $delid";
					...
					<!-- Select course start-->
                	  <?php
                        	$db=new courseDatabase(); 
                            $query="SELECT * FROM second_semester ORDER BY ID DESC";
						...
						<tr class="odd gradeX" >
							...
							<td><a href="editCourseSecond.php?editCourseid=<?php echo $Courseresult['id'] ;?>">Edit</a> || <a onclick="return confirm('are you sure to delete')" href="?delid=<?php echo $Courseresult['id'] ;?>">Delete</a></td>
						</tr>
							   <?php }}?>
