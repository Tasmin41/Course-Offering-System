        ...
        <div class="container">
			...
			<?php
			    if(isset($_POST['submit'])){
                    ...
                    $updated_rows = $db->courseUpdate($query);
                    if( $updated_rows){
                        echo "<span class='success' style='padding-left:20px; padding-top:20px;'>Data Updated Successfully.
                        </span>";
                    }else{
                        echo "<span class='error' style='padding-left:20px; padding-top:20px;'>Data Not Updated !</span>";
                    }	 
				}
			?>
            ...
            <?php
				    //select for edit
				        $editCourse="select * from second_semester where id='$editCourseid'";
				        $getCourse = $db->courseSelect($editCourse);
					    if($getCourse){    
				            while($getresult=$getCourse->fetch_assoc()){
				        ?> 
                <div class="mb-3 input">
                    <label>course Code:</label><input type="text" value="<?php echo $getresult['course_code'] ;?>" name="course_code" />
                </div>
                <div class="mb-3 input">
                <label>course Title:</label><input type="text" value="<?php echo $getresult['course_title'] ;?>" name="course_title" />
                </div>
                <div class="mb-3 input">
                <label>Credit:</label><input type="text" value="<?php echo $getresult['credit'] ;?>" name="credit" /><br>
                </div>
                <div class="mb-3 input">
                <label>Prerequisite:</label><input type="text" value="<?php echo $getresult['prerequisite'] ;?>" name="prerequisite" />
                </div>
                <?php }}?>
